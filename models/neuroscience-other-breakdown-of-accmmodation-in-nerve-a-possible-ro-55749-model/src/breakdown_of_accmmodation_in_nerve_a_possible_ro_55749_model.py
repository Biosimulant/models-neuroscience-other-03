...
"""Auto-generated BioModule wrapper for Breakdown of accmmodation in nerve: a possible role for INAp (Hennings et al 2005).

Source: modeldb:55749
Original: https://modeldb.science/55749
Standard: other
...
class OtherBreakdownOfAccmmodationInNerveAPossibleRoleForInap(bsim.BioModule):
    """Placeholder BioModule wrapper for: Breakdown of accmmodation in nerve: a possible role for INAp (Hennings et al 2005).
...
BreakdownOfAccmmodationInNerveAPossibleRo55749Model = OtherBreakdownOfAccmmodationInNerveAPossibleRoleForInap
