...
"""Auto-generated BioModule wrapper for AIS model of L5 cortical pyramidal neuron (Filipis et al., 2023).

Source: modeldb:267355
Original: https://modeldb.science/267355
Standard: other
...
class OtherAisModelOfL5CorticalPyramidalNeuronFilipisEtAl2023(biosim.BioModule):
    """BioModule wrapper for: AIS model of L5 cortical pyramidal neuron (Filipis et al., 2023).""""""

    def __init__(self, model_path: str = "data/267355.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AisModelOfL5CorticalPyramidalNeuronFilipi267355Model = OtherAisModelOfL5CorticalPyramidalNeuronFilipisEtAl2023
