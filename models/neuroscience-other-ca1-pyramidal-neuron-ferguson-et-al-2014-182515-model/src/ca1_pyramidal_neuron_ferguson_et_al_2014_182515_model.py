...
"""Auto-generated BioModule wrapper for CA1 pyramidal neuron (Ferguson et al. 2014).

Source: modeldb:182515
Original: https://modeldb.science/182515
Standard: other
...
class OtherCa1PyramidalNeuronFergusonEtAl2014(biosim.BioModule):
    """Placeholder BioModule wrapper for: CA1 pyramidal neuron (Ferguson et al. 2014).
    ...
    def __init__(self, model_path: str = "data/182515.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ca1PyramidalNeuronFergusonEtAl2014182515Model = OtherCa1PyramidalNeuronFergusonEtAl2014
