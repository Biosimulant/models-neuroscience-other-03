...
"""Auto-generated BioModule wrapper for BK - CaV coupling (Montefusco et al. 2017).

Source: modeldb:266841
Original: https://modeldb.science/266841
Standard: other
...
class OtherBkCavCouplingMontefuscoEtAl2017(biosim.BioModule):
    """Placeholder BioModule wrapper for: BK - CaV coupling (Montefusco et al. 2017).
    ...
    def __init__(self, model_path: str = "data/266841.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BkCavCouplingMontefuscoEtAl2017266841Model = OtherBkCavCouplingMontefuscoEtAl2017
