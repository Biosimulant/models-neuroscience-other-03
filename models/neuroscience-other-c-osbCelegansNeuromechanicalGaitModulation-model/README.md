...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/CelegansNeuromechanicalGaitModulation)
**Standard**: other
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-other-c-osbCelegansNeuromechanicalGaitModulation-model/model.yaml
```
