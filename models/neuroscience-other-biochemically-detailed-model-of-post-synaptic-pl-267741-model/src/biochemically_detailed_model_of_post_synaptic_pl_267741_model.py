...
class OtherBiochemicallyDetailedModelOfPostSynapticPlasticity(biosim.BioModule):
    """BioModule wrapper for: Biochemically detailed model of post-synaptic plasticity for computational analyses of schizophrenia (Maki-Marttunen et al. in press)."""
