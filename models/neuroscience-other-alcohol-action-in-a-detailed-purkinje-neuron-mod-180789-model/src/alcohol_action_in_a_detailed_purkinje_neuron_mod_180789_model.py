...
"""Auto-generated BioModule wrapper for Alcohol action in a detailed Purkinje neuron model and an efficient simplified model (Forrest 2015).

Source: modeldb:180789
Original: https://modeldb.science/180789
Standard: other
...
class OtherAlcoholActionInADetailedPurkinjeNeuronModelAndAn(bsim.BioModule):
    """Placeholder BioModule wrapper for: Alcohol action in a detailed Purkinje neuron model and an efficient simplified model (Forrest 2015).
...
AlcoholActionInADetailedPurkinjeNeuronMod180789Model = OtherAlcoholActionInADetailedPurkinjeNeuronModelAndAn
