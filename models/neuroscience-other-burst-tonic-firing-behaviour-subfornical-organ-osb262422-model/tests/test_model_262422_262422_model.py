...
"""Auto-generated tests for Model262422262422Model.
...
from src.model_262422_262422_model import Model262422262422Model  # noqa: E402
from biosim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = Model262422262422Model()
...
def test_advance_produces_outputs() -> None:
    module = Model262422262422Model(min_dt=0.1)
