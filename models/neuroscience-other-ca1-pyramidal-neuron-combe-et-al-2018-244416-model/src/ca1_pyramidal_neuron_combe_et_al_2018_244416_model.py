...
"""Auto-generated BioModule wrapper for CA1 pyramidal neuron (Combe et al 2018).

Source: modeldb:244416
Original: https://modeldb.science/244416
Standard: other
...
class OtherCa1PyramidalNeuronCombeEtAl2018(biosim.BioModule):
    """Placeholder BioModule wrapper for: CA1 pyramidal neuron (Combe et al 2018).
    ...
    def __init__(self, model_path: str = "data/244416.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ca1PyramidalNeuronCombeEtAl2018244416Model = OtherCa1PyramidalNeuronCombeEtAl2018
