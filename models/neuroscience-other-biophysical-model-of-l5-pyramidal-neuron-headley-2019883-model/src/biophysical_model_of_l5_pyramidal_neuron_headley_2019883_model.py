...
"""Auto-generated BioModule wrapper for Biophysical model of L5 Pyramidal Neuron (Headley, Latimer et al., 2025).

Source: modeldb:2019883
Original: https://modeldb.science/2019883
Standard: other
...
class OtherBiophysicalModelOfL5PyramidalNeuronHeadleyLatimerEt(bsim.BioModule):
    """Placeholder BioModule wrapper for: Biophysical model of L5 Pyramidal Neuron (Headley, Latimer et al., 2025).
...
BiophysicalModelOfL5PyramidalNeuronHeadley2019883Model = OtherBiophysicalModelOfL5PyramidalNeuronHeadleyLatimerEt
