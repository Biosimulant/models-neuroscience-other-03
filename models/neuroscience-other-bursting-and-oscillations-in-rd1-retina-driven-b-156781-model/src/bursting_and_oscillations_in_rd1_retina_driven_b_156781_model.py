...
"""Auto-generated BioModule wrapper for Bursting and oscillations in RD1 Retina driven by AII Amacrine Neuron (Choi et al. 2014).

Source: modeldb:156781
Original: https://modeldb.science/156781
Standard: other
...
class OtherBurstingAndOscillationsInRd1RetinaDrivenByAii(bsim.BioModule):
    """Placeholder BioModule wrapper for: Bursting and oscillations in RD1 Retina driven by AII Amacrine Neuron (Choi et al. 2014).
...
BurstingAndOscillationsInRd1RetinaDrivenB156781Model = OtherBurstingAndOscillationsInRd1RetinaDrivenByAii
