...
"""Auto-generated BioModule wrapper for An agent-based computational model for cortical layer formation (Bauer et al 2021).

Source: modeldb:266895
Original: https://modeldb.science/266895
Standard: other
...
class OtherAnAgentBasedComputationalModelForCorticalLayer(bsim.BioModule):
    """Placeholder BioModule wrapper for: An agent-based computational model for cortical layer formation (Bauer et al 2021).
...
AnAgentBasedComputationalModelForCortical266895Model = OtherAnAgentBasedComputationalModelForCorticalLayer
