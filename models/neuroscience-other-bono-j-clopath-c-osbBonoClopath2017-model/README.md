...
**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/BonoClopath2017)
**Standard**: other
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-other-bono-j-clopath-c-osbBonoClopath2017-model/model.yaml
```
