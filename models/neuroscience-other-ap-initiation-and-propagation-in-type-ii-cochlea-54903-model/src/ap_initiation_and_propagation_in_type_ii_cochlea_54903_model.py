...
"""Auto-generated BioModule wrapper for AP initiation and propagation in  type II cochlear ganglion cell (Hossain et al 2005).

Source: modeldb:54903
Original: https://modeldb.science/54903
Standard: other
...
class OtherApInitiationAndPropagationInTypeIiCochlearGanglion(biosim.BioModule):
    """BioModule wrapper for: AP initiation and propagation in  type II cochlear ganglion cell (Hossain et al 2005).""""""

    def __init__(self, model_path: str = "data/54903.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ApInitiationAndPropagationInTypeIiCochlea54903Model = OtherApInitiationAndPropagationInTypeIiCochlearGanglion
