...
"""Auto-generated BioModule wrapper for Boolean network-based analysis of the apoptosis network (Mai and Liu 2009).

Source: modeldb:144586
Original: https://modeldb.science/144586
Standard: other
...
class OtherBooleanNetworkBasedAnalysisOfTheApoptosisNetworkMai(bsim.BioModule):
    """Placeholder BioModule wrapper for: Boolean network-based analysis of the apoptosis network (Mai and Liu 2009).
...
BooleanNetworkBasedAnalysisOfTheApoptosis144586Model = OtherBooleanNetworkBasedAnalysisOfTheApoptosisNetworkMai
