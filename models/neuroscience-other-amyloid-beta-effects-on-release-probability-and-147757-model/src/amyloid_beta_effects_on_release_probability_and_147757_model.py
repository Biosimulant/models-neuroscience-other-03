...
"""Auto-generated BioModule wrapper for Amyloid-beta effects on release probability and integration at CA3-CA1 synapses (Romani et al. 2013).

Source: modeldb:147757
Original: https://modeldb.science/147757
Standard: other
...
class OtherAmyloidBetaEffectsOnReleaseProbabilityAndIntegration(biosim.BioModule):
    """BioModule wrapper for: Amyloid-beta effects on release probability and integration at CA3-CA1 synapses (Romani et al. 2013)."""

    def __init__(self, model_path: str = "data/147757.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AmyloidBetaEffectsOnReleaseProbabilityAnd147757Model = OtherAmyloidBetaEffectsOnReleaseProbabilityAndIntegration
