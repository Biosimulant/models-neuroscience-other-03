...
"""Auto-generated BioModule wrapper for Biophysical basis of Subthalamic LFPs Recorded from DBS electrodes (Maling et al 2018).

Source: modeldb:262368
Original: https://modeldb.science/262368
Standard: other
...
class OtherBiophysicalBasisOfSubthalamicLfpsRecordedFromDbs(biosim.BioModule):
    """BioModule wrapper for: Biophysical basis of Subthalamic LFPs Recorded from DBS electrodes (Maling et al 2018).""""""

    def __init__(self, model_path: str = "data/262368.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
BiophysicalBasisOfSubthalamicLfpsRecordedF262368Model = OtherBiophysicalBasisOfSubthalamicLfpsRecordedFromDbs
