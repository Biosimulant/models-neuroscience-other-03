...
"""Auto-generated BioModule wrapper for Axon growth model (Diehl et al. 2016).

Source: modeldb:187687
Original: https://modeldb.science/187687
Standard: other
...
class OtherAxonGrowthModelDiehlEtAl2016(biosim.BioModule):
    """Placeholder BioModule wrapper for: Axon growth model (Diehl et al. 2016).
    ...
    def __init__(self, model_path: str = "data/187687.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AxonGrowthModelDiehlEtAl2016187687Model = OtherAxonGrowthModelDiehlEtAl2016
